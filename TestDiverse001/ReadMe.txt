========================================================================
    KONSOLENANWENDUNG: TestDiverse001-Projektübersicht
========================================================================

Diese TestDiverse001-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre TestDiverse001-Anwendung besteht.


TestDiverse001.vcxproj
...
TestDiverse001.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen TestDiverse001.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
